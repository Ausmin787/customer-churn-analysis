...
bar_colors = [
    CHURNED_COLOR if r >= 50 else (STAYED_COLOR if r < 15 else "#f39c12")
...
geo_colors = [HIGHLIGHT_COLOR if g == "Germany" else NEUTRAL_COLOR for g in geo_df["Geography"]]
